...
public:
    ...
    // Metodo para asignar el nombre, año, mes, dia.
    int Asignar_Nombre(std::string elNombre);
    int Asignar_FechaNacimiento(int Anio, int Mes, int Dia);
    int Asignar_LugarOrigen(std::string Lugar);

   
    /* Metodo para obtener el DPI a una persona (get) */
    std::string Obtener_DPI( );

    //Metodos de obtencion (get) nombre, año de nacimiento, mes de nacimiento, dia de nacimiento y lugar de origen
