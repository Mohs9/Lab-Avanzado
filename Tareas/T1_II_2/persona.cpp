...
/* Metodos para asignar el Nombre, la fecha de nacimiento y el lugar de origen (set method)
 * devuelve 0 si se realiza la asignacion;
 * 1 si no. */
...
/* Metodos para obtener el nombre, fecha de nacimiento y el lugar de orige de una persona (get method)
 * devuelve un string con el numero de nombre y lugar de nacimeinto y un entero para la fecha */
